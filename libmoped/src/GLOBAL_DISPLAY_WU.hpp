...
namespace MopedNS {
	...
	class GLOBAL_DISPLAY_WU:public MopedAlg {

		int display;
	public:

		GLOBAL_DISPLAY_WU( int display )
		: display(display) { }
		...
		void process(FrameData &frameData) {
			...
			/*	"UNDISTORTORTED_IMAGE"
				...
				string windowName = "MOPED v0.2 Experimental modified";
